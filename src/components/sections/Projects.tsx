...
const Projects = () => {
  ...
  return (
    <section
      id="projects"
      className="py-20 relative min-h-screen bg-gradient-to-b from-primary-50 to-white"
      ref={containerRef}
    >
      {/* animated background */}
      <div className="absolute inset-0 overflow-hidden -z-10 opacity-20 pointer-events-none">
        <div
          ...
          style={{
            backgroundImage: `radial-gradient(ellipse at center, rgba(6, 182, 212, 0.2) 0%, rgba(14, 165, 233, 0.1) 50%, rgba(0, 0, 0, 0) 70%)`,
