...
const SoundToggle = ({ className = "" }: SoundToggleProps) => {
  ...
  const audioUrl = "https://marcushudnell.com/ocean-waves.wav";
  ...
  return (
    <div
      className={`fixed bottom-6 right-4 md:bottom-12 md:right-12 z-50 flex flex-col items-center ${className}`}
    >
      <p className="hidden md:text-sm font-medium mb-2 px-3 py-1.5 bg-white/80 backdrop-blur-sm rounded-lg text-primary-600 shadow-md">
        {isPlaying ? "Mute Ocean Sounds" : "Play Ocean Sounds"}
      </p>
      <button
        onClick={toggleSound}
      ...
      >
        {isPlaying ? (
          ...
          >
            <path
              d="M2 10C4 7 6 6 10 6C14 6 16 8 20 8C22 8 23 7 24 6"
              strokeLinecap="round"
            />
            <path
              d="M2 18C4 15 6 14 10 14C14 14 16 16 20 16C22 16 23 15 24 14"
              strokeLinecap="round"
            />
          </svg>
        ) : (
          ...
          >
            ...
            <path
              d="M2 18C4 15 6 14 10 14C12 14 13 15 14 16"
              strokeLinecap="round"
            />
